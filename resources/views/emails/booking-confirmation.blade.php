    ...
    <body>
        <div>
            <div style="display: block;margin: auto;width: 100%;max-width: 426px;padding: 40px 32px 32px 32px;border-radius: 16px;border: 1px solid #EFEEEE;background: #FFF;">
                <h1 style="text-align: center;font-family: 'PPFormulaCondensed', Tahoma, Arial, sans-serif;font-size: 34px;font-style: normal;font-weight: 700;text-transform: uppercase;margin: 0;">BOOKING CONFIRMED</h1>
                <div>
